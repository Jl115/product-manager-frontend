// Importing necessary Angular core and Material components
...
@Component({
  ...
  imports: [
    // Specifies Angular modules used in this component.
    ReactiveFormsModule,
    MatFormFieldModule,
    MatInputModule,
    MatButtonModule,
...
export class RegisterComponent {
  // FormGroup to handle registration form data.
  registerForm: FormGroup;

  // Flag to track if there's an error during registration.
  isError = false;
